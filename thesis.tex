...
\par
\chapter{\texorpdfstring{\MakeUppercase{Augmented Reality and Virtual Reality}}{aug-reality}}
...
\\
\chapter{\texorpdfstring{\MakeUppercase{Project use case}}{proj-use-case}}
...
\par
\chapter{\texorpdfstring{\MakeUppercase{Project definition}}{proj-def}}
...
\par
\chapter{\texorpdfstring{\MakeUppercase{Project implementation}}{proj-impl}}
...
Using gloves to interact with objects in the virtual environment can be achieved with simulated physics. The gloves actor in the scene is 
...
\par
\chapter{\texorpdfstring{\MakeUppercase{Analyzing the mixed reality training application}}{analysis-mixedr}}

...
%Interview questions(should add responses to appendix and reference them) ->
%How was the training generally done?
%What kind of media did it include(slides, videos, pictures, text, audio.. etc)?
%What was the size of the training group?
%Was the actual system put into use during the training
%Were possible scenarios simulated or rehearsed in some way?
%Estimated readiness and knowledge attained by the trainees(How well do you think they've learned)?
%What was the feedback from the trainees?

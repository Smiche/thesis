...
Use case is a training system with or without the physical environment. Observis Oy is
developing a product for Situational Awareness in different environments. The systems the software
can be integrated into vary a lot and so does the complexity of the various applications associated with the product.
Training is becoming necessary to ensure proper use of the software and other components of the situational awareness system.

...
An AR framework has three basic requirements to accomplish a combination of the real and virtual world.
The four main requirements are sensing, tracking, interaction and display\Cref{fig:ar-framework}.

\begin{figure}[H]
\includegraphics[width=\textwidth]{ar-framework}
\caption{Reality-Virtuality Continuum \citep{vrjournal}}
...
\section{Future possibilities for development and improvement hoe hoe}
